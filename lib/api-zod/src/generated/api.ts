...
export const GetSettingsResponse = zod.object({
  ...
  maxRainChance: zod.number(),
  maxAqi: zod.number(),
  indoorTemp: zod.number(),
...
export const UpdateSettingsBody = zod.object({
  ...
  maxRainChance: zod.number().optional(),
  maxAqi: zod.number().optional(),
  indoorTemp: zod.number().optional(),
